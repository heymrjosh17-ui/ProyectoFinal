...
public class Indexpersona {
    ...
    // --- Accessors used by GestionDatos for centralized persistence ---
    public static int[] getCodigos() { return codigos; }
    public static String[] getNombres() { return nombres; }
    public static String[] getPaternos() { return paternos; }
    public static String[] getMaternos() { return maternos; }
    public static int[] getDnis() { return dnis; }
    public static int[] getFonos() { return fonos; }
    public static String[] getDires() { return dires; }
    public static String[] getEmails() { return emails; }
    public static int getCont() { return cont; }

    public static void setDatos(int[] codigosIn, String[] nombresIn, String[] paternosIn, String[] maternosIn,
            int[] dnisIn, int[] fonosIn, String[] diresIn, String[] emailsIn, int contIn) {
        // Ensure arrays have expected length; if not, create new arrays with proper size
        if (codigosIn != null) codigos = codigosIn; else codigos = new int[100];
        if (nombresIn != null) nombres = nombresIn; else nombres = new String[100];
        if (paternosIn != null) paternos = paternosIn; else paternos = new String[100];
        if (maternosIn != null) maternos = maternosIn; else maternos = new String[100];
        if (dnisIn != null) dnis = dnisIn; else dnis = new int[100];
        if (fonosIn != null) fonos = fonosIn; else fonos = new int[100];
        if (diresIn != null) dires = diresIn; else dires = new String[100];
        if (emailsIn != null) emails = emailsIn; else emails = new String[100];
        cont = contIn;
    }
}
